...
-   **WebSocket Communication:** `IXWebSocket` (included as a git submodule). A lightweight, cross-platform WebSocket library used for real-time communication with the server.
